...
function PokazProdukty($link) {
    ...
    $output .= '<p><a href="admin.php?action=products&sub_action=add" style="padding:10px; background:#1C6C1D; color:white; text-decoration:none;">+ Dodaj Produkt</a></p>';
...
function ZarzadzajProdukty($link, $mode, $id = 0) {
    ...
    // --- OBSŁUGA FORMULARZA (ADD / EDIT) --- [cite: 19, 21]
    ...
    $data = ['tytul'=>'','opis'=>'','cena_netto'=>0,'podatek_vat'=>23,'ilosc_sztuk'=>0,'status_dostepnosci'=>1,'kategoria_id'=>0,'gabaryt'=>'','zdjecie_link'=>'','data_wygasniecia'=>''];
    if ($mode === 'edit') {
