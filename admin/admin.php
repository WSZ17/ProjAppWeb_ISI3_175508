...
function ListaPodstron($link) {
    echo '<p><a href="admin.php?action=add" style="padding: 10px; background-color: #6C1D1C;; color: white; text-decoration: none; border-radius: 2px;">Dodaj nową podstronę</a></p>';
